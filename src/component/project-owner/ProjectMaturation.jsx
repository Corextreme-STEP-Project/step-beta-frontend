        ...
        <div className="p-8 bg-white shadow-md rounded-lg mt-8">
            ...
            <div>
                ...
                <div className="mt-6 flex justify-start space-x-4">
                    <button className="px-5 py-2 bg-blue-500 text-white font-medium rounded-md hover:bg-blue-600 transition">
                        Start New Project
                    </button>
                    <button className="px-5 py-2 bg-gray-200 text-gray-700 font-medium rounded-md hover:bg-gray-300 transition">
                        View Project Status
                    </button>
                </div>
            </div>
